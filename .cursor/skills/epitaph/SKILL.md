...
name: epitaph
description: >-
  Write and maintain Epitaph (墓志铭) handoff notes under docs/epitaph/ for ohMyWorkPanel.
...
双槽位相关墓志铭必写：prod `:8080` + data 路径、canary `:8081`、promote 不碰 DB、生产群组 ohMyWorkPanel。
