---
date: 2026-08-06
topic: ohmyworkpanel-v1.3.0-workflow-era
status: approved-implementing
decider: user 2026-08-06「设计通过开工」
choice: C — full design; implement S1→S4
---

# 设计：ohMyWorkPanel V1.3.0「工作流时代」

## 0. 命名与范围

| 名称 | 含义 |
|---|---|
| **ohMyWorkPanel V1.3.0（工作流）** | 本产品里程碑：版本页 + Roadmap/Wave/Ask |
...
- V1.3.0 命名与历史 epitaph v1.3 并存——文档一律写「ohMyWorkPanel V1.3.0（工作流）」。
