---
date: 2026-08-22
topic: ohmyworkpanel-v2.1.1-shell-visual-parity
status: accepted
...
> 交互契约仍以 [`2026-08-22-ohmyworkpanel-v2.1-chrome-extend-design.md`](2026-08-22-ohmyworkpanel-v2.1-chrome-extend-design.md) 为准（四页签、dock、斜杠三条、贡献协议）。本文件只解决 **「产品不像那张稿」**。
